...
/**
 * @file	MultiplePlanarObjectThreadTracking.h
 * @author	Woonhyuk Baek
 * @version 2.0
 * @date	2010.02.04
...
#ifndef _MULTIPLE_PLANAR_OBJECT_THREAD_TRACKING_H_
#define _MULTIPLE_PLANAR_OBJECT_THREAD_TRACKING_H_
...
#define PoseEstimationT windage::Algorithms::RANSACestimator
...
namespace windage
{
	namespace Frameworks
	{
		 ...
		 * @author	Woonhyuk Baek
		 */
		class DLLEXPORT MultiplePlanarObjectThreadTracking
		{
		protected:
		...
		public:
			virtual char* GetFunctionName(){return "MultiplePlanarObjectThreadTracking";};
			MultiplePlanarObjectThreadTracking()
			{
			...
			virtual ~MultiplePlanarObjectThreadTracking()
			{
...
#endif // _MULTIPLE_PLANAR_OBJECT_THREAD_TRACKING_H_