...
windage::Matrix4 CalculateRelationExtrinsicParameter(windage::Calibration* fromCalibration, windage::Matrix3 toRotation, windage::Vector3 toTranslation)
{
	CvMat* fromExtrinsicMatrix = fromCalibration->GetExtrinsicMatrix();
	...
	windage::Matrix3 rotation = toRotation;
	windage::Vector3 translation = toTranslation;
