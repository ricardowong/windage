...
class RANSACestimatorTest : public windageTest
{
private:
	IplImage* grayImage;
...
public:
	...
	bool TestMemoryRelease(std::string* message)
	{
		...
		windage::Algorithms::RANSACestimator* estimator1 = new windage::Algorithms::RANSACestimator();
		p1 = (void*)estimator1;
		...
		windage::Algorithms::RANSACestimator* estimator2 = new windage::Algorithms::RANSACestimator();
		p2 = (void*)estimator2;
