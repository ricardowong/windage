...
namespace windage
{
	...
	public:
		...
		static windage::Vector3 DcmToEuler(windage::Matrix3 dcm)
		{
			...
			eular = windage::Quaternion::QuaternionToEuler(windage::Quaternion::DcmToQuaternion(dcm));
			return eular;
		}
		...
		{
			windage::Matrix3 dcm;
			dcm = windage::Quaternion::QuaternionToDcm(windage::Quaternion::EulerToQuaternion(euler));
			return dcm;
		}
	};
}
