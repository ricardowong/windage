...
Vector3 MultiCameraCoordinate::GetTranslation(Calibration* baseCalibration, Calibration* toCalibration)
{
...
Matrix3 MultiCameraCoordinate::GetRotation(Calibration* baseCalibration, Calibration* toCalibration)
{
	CvMat* toExtrinsicMatrix = toCalibration->GetExtrinsicMatrix();
	CvMat* fromExtrinsicMatrix = baseCalibration->GetExtrinsicMatrix();
...
Matrix4 MultiCameraCoordinate::CalculateExtrinsic(Calibration* baseCalibration, Matrix3 toRotation, Vector3 toTranslation)
{
	CvMat* fromExtrinsicMatrix = baseCalibration->GetExtrinsicMatrix();
