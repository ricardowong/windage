...
void Utils::DrawTextToImage(IplImage* colorImage, CvPoint position, double scale, char* message)
{
	CvFont outLineFont, font;
	cvInitFont(&outLineFont, CV_FONT_HERSHEY_COMPLEX_SMALL, scale, scale, 0, 5);
	cvInitFont(&font, CV_FONT_HERSHEY_COMPLEX_SMALL, scale, scale, 0, 1);
