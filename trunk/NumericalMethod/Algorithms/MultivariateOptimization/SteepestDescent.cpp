...
Vector2 SteepestDescent::FindGradient(Vector2 xk)
{
...
double SteepestDescent::FindSetpLength(Vector2 xk, Vector2 pk)
{
	double alpha = 0.0;
...
bool SteepestDescent::Calculate(double* solutionX, double* solutionY)
{
