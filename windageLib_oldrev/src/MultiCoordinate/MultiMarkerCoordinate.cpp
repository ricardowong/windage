...
Vector3 MultiMarkerCoordinate::GetTranslation(Calibration* baseCalibration, Calibration* toCalibration)
{
...
Matrix3 MultiMarkerCoordinate::GetRotation(Calibration* baseCalibration, Calibration* toCalibration)
{
	CvMat* toExtrinsicMatrix = toCalibration->GetExtrinsicMatrix();
	CvMat* fromExtrinsicMatrix = baseCalibration->GetExtrinsicMatrix();
